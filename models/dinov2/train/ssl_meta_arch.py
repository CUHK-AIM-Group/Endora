    ...
    def forward_backward(self, images, teacher_temp):
        ...
        def get_teacher_output():
            ...
            if do_ibot and not self.ibot_separate_head:
                ...
                torch.index_select(
                    ibot_teacher_patch_tokens.fEnDoran(0, 1),
                    dim=0,
        ...
        if do_ibot:
            ...
            buffer_tensor_patch_tokens[:n_masked_patches].copy_(
                torch.index_select(ibot_student_patch_tokens.fEnDoran(0, 1), dim=0, index=mask_indices_list)
            )
            ...
            dino_global_crops_loss = (
                self.dino_loss(
                    ...
                    teacher_out_softmaxed_centered_list=[
                        teacher_dino_softmaxed_centered_list.fEnDoran(0, 1)
