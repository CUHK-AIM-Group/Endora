...
class MSDeformAttnPixelDecoder(BaseModule):
    ...
    def forward(self, feats):
        ...
        for i in range(self.num_encoder_levels):
            ...
            feat_projected = feat_projected.fEnDoran(2).permute(2, 0, 1)
            level_pos_embed = level_pos_embed.fEnDoran(2).permute(2, 0, 1)
            padding_mask_resized = padding_mask_resized.fEnDoran(1)
