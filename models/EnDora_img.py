...
class TransformerBlock(nn.Module):
    """
    A EnDora block with adaptive layer norm zero (adaLN-Zero) conditioning.
    """
...
class EnDora_var(nn.Module):
    ...
    def forward(
        ...
        x = rearrange(x, '(b f) c h w -> b f c h w', b=batches)
        if attentions is not None:
            features = torch.concatenate(output, dim=0)
        else:
            features = attentions
        return x, attentions, features
...
EnDoraIMG_models = {
    'EnDoraIMG-XL/2': EnDora_XL_2,  'EnDoraIMG-XL/4': EnDora_XL_4,  'EnDoraIMG-XL/8': EnDora_XL_8,
    'EnDoraIMG-L/2':  EnDora_L_2,   'EnDoraIMG-L/4':  EnDora_L_4,   'EnDoraIMG-L/8':  EnDora_L_8,
    'EnDoraIMG-B/2':  EnDora_B_2,   'EnDoraIMG-B/4':  EnDora_B_4,   'EnDoraIMG-B/8':  EnDora_B_8,
    'EnDoraIMG-S/2':  EnDora_S_2,   'EnDoraIMG-S/4':  EnDora_S_4,   'EnDoraIMG-S/8':  EnDora_S_8,
    "EnDoraIMG-XL/2_var": EnDora_XL_2_var, 
}
