...
def make_dataset_col(dir, nframes, class_to_idx, frame_stride=1, **kwargs):
    """
...
class VideoFrameDataset(data.Dataset):
    def __init__(self,
        ...
        elif dataset_name == 'sky' or dataset_name == 'col' or dataset_name == 'cholec' or dataset_name == 'kvasir':
        ...
        elif dataset_name == 'col' or dataset_name == 'cholec' or dataset_name == 'kvasir':
            func = make_dataset_col
        else:
            func = make_dataset
        ...
        if subset_split == 'all' and dataset_name != 'col' and dataset_name != 'cholec' and dataset_name != 'kvasir':
            # add test videos
