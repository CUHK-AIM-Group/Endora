...
def calc_metrics_for_dataset(metrics, real_data_path, fake_data_path, mirror, resolution, gpus, verbose, use_cache: bool, num_runs: int):
    dnnlib.util.Logger(should_flush=True)
...
def calc_metrics_cli_wrapper(metrics, real_data_path, fake_data_path, mirror, resolution, gpus, verbose, use_cache, num_runs):
    calc_metrics_for_dataset(metrics, real_data_path, fake_data_path, mirror, resolution, gpus, verbose, use_cache, num_runs)
