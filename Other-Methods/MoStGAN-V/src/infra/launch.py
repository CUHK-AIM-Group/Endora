...
def main(cfg: DictConfig):
    ...
    training_cmd = f'{before_train_cmd}cd {cfg.project_release_dir} && {cfg.env.python_bin} src/train.py {HYDRA_ARGS}' # 
    ...
    if cfg.slurm:
        ...
        for i in range(cfg.job_sequence_length):
            ...
            submit_job_cmd = f'sbatch {cfg.sbatch_args_str} {output_file_arg_str} {qos_arg_str} --export=ALL, src/infra/slurm_job_proxy.sh {cfg.env_args.python_script} {cfg.project_release_dir}'
