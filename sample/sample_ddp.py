...
"""
Samples a large number of images from a pre-trained EnDora model using DDP.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="/data1/tempt01/code/EnDora/configs/col/col_sample_128.yaml")
    parser.add_argument("--ckpt", type=str, default="/data1/tempt01/code/EnDora/results/013-EnDora-XL-2-F16S3-col/checkpoints/0100000.pt")
    parser.add_argument("--save_video_path", type=str, default="/data1/tempt01/code/EnDora/results/col210_5_128_EnDora_video_2048")
    parser.add_argument("--port", type=int, default=6045)
